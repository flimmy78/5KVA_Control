...
#include "main.h"                // DSP2833x main Include File
...
/* Configure bit timing parameters for eCANA*/
	...
	/* The following block is only for 100 MHz SYSCLKOUT. Bit rate = 0.4 Mbps */
...
/* Configure bit timing parameters for eCANB*/
    ...
    /* The following block for all 150 MHz SYSCLKOUT - default. Bit rate = 250 kbps */
            		...
            		ECanbShadow.CANBTC.bit.TSEG1REG = 12;
	#endif
	#if (CPU_FRQ_100MHZ)                       // CPU_FRQ_100MHz is defined in DSP2833x_Examples.h
...
// Configure Mailboxes 0-1 as Tx, 2-3 as Rx
...
EALLOW;
    ...
    ECanbShadow.CANGIM.bit.GIL = 1;    // Configure CAN for normal mode
